...
playerDataBinder.addEventListener(
    ...
    (e) => {
        ...
        switch (e.value) {
            ...
            // document.getElementById("div_idle").style.display = "block";
            document.getElementById("myMediaEl").style.display = "none";
            break;
            case cast.framework.ui.State.LOADING:
            // Write your own event handling code
            // document.getElementById("div_idle").style.display = "none";
...
// document.getElementById('myframe1').addEventListener( "load", function(e) {
//   console.log("myframe1 loaded");

//   this.contentWindow.document.getElementById("link1").addEventListener( "click", function(e) {
//     e.preventDefault();
//     console.log("link1 clicked");

//     let mi = new cast.framework.messages.MediaInformation();
//     // mi.contentUrl = 'https://storage.googleapis.com/cpe-sample-media/content/ForBiggerFun/ForBiggerFun_master.mpd';
//     mi.contentType = TEST_STREAM_TYPE;
//     mi.contentId = 'bbb';

//     //playerManager.setMediaInformation(mi);
